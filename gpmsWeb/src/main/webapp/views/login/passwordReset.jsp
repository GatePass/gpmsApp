					...
					<td>
						<div align="center">
							<fieldset id="fieldSet">
								<sf:form action="passwordReset"
									modelAttribute="passwordResetBean">
									<table cellspacing="20px"
										style="min-height: 50%; min-width: 50%;">
										<tr>
											<td class="boxHeading" align="left"><b> <label><spring:message
															code="pageHeader.resetPassword.text" /></label>
											</b></td>
										</tr>
										<tr>
										...
										<tr>
											<td align="left"><b><sf:label path="secretQuesAnsId">
														<spring:message
															code="label.resetPassword.secretQuestionAnswer.text" />
													</sf:label></b></td>
											<td><sf:input path="secretQuesAnsId" /><br /> <sf:errors
													path="secretQuesAnsId" cssClass="error" /></td>
										</tr>
										<tr>
											<td align="left"><b><sf:label path="newPasswordId">
														<spring:message
															code="label.resetPassword.enterNewPassword.text" />
													</sf:label></b></td>
											<td><sf:password path="newPasswordId" /><br /> <sf:errors
													path="newPasswordId" cssClass="error" /></td>
										</tr>
										<tr>
											<td align="left"><b><sf:label
														path="reenterNewPasswordId">
														<spring:message
															code="label.resetPassword.reenterNewPassword.text" />
													</sf:label></b></td>
											<td><sf:password path="reenterNewPasswordId" /><br /> <sf:errors
													path="reenterNewPasswordId" cssClass="error" /></td>
										</tr>
									</table>
									<input type="submit"
